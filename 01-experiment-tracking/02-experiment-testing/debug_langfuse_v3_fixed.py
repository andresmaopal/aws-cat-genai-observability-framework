#!/usr/bin/env python3
"""
Fixed debug script for Langfuse V3 tracing issues
"""
...
def test_langfuse_v3_direct():
    ...
    try:
        ...
        # Create a simple trace using correct V3 API
        ...
        # Create a span using correct V3 API
...
def test_strands_agent_tracing():
    ...
    try:
        ...
        # Test simple query using correct method
        response = agent.invoke("Say hello and confirm tracing is working")
...
def test_opentelemetry_setup():
    ...
    try:
        ...
        # Test basic OTEL setup without conflicting with existing tracer
        from opentelemetry import trace
        
        # Get current tracer (don't override if already set)
...
def main():
    """Run all debug tests"""
    print("🚀 Starting Langfuse V3 Debug Tests (Fixed)\n")
